 ...
 */
public class GcpHttpFunctionFast implements HttpFunction {
    ...
    public void service(HttpRequest httpRequest, HttpResponse httpResponse) throws Exception {
        ...
        // Logging
        LOGGER.info("Java HTTP [" + httpRequest.getMethod() + "] trigger processed a fast request with body: " + jsonBody);
